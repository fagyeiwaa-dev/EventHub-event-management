  ...
  <div className="mx-auto max-w-7xl">
    <div className="text-center">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-gray-600">
        ...
        registrations, and keep track of the experiences that matter to you.
      </p>
    </div>
  ...
  <div className="mx-auto max-w-7xl">
    ...
    <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="overflow-hidden rounded-xl bg-white shadow-md transition hover:-translate-y-1 hover:shadow-xl">
        <div className="flex h-48 items-center justify-center bg-blue-100 text-5xl">
          🎤
        </div>
        ...
        <div className="p-6">
          ...
          <p className="mt-3 text-sm text-gray-600">
            Enjoy an unforgettable evening of live performances and
            entertainment.
          </p>
      ...
      {/* Event 2 */}
      <div className="overflow-hidden rounded-xl bg-white shadow-md transition hover:-translate-y-1 hover:shadow-xl">
        <div className="flex h-48 items-center justify-center bg-green-100 text-5xl">
          💻
        </div>
        ...
        <div className="p-6">
          ...
          <p className="mt-3 text-sm text-gray-600">
            Connect with technology enthusiasts, developers, and industry
            professionals.
          </p>
      ...
      {/* Event 3 */}
      <div className="overflow-hidden rounded-xl bg-white shadow-md transition hover:-translate-y-1 hover:shadow-xl">
        <div className="flex h-48 items-center justify-center bg-purple-100 text-5xl">
          🎨
        </div>
        ...
        <div className="p-6">
          ...
          <p className="mt-3 text-sm text-gray-600">
            Experience local art, culture, creativity, and inspiring
            performances.
          </p>
